  ...
  return new Promise((resolve) => {
    ...
    fetch(searchUrl)
      ...
      .then(html => {
        ...
        // If we couldn't scrape real data (e.g., due to CORS), fall back to demo data
        if (alternatives.length === 0) {
          console.log('Falling back to demo data for:', cleanedTerm);
          
          // Create fallback data based on search term
      ...
      .catch(error => {
        console.error('Error fetching Leboncoin results:', error);
